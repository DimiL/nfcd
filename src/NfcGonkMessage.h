...
typedef enum {
  ...
  NFC_ERROR_SE_ALREADY_SELECTED = -24,
  NFC_ERROR_SE_CONNECTED = -25,
  NFC_ERROR_NO_SE_CONNECTED = -26,
  NFC_ERROR_NOT_SUPPORTED = -27,
  NFC_ERROR_BAD_SESSION_ID = -28,
  NFC_ERROR_LOST_TECH = -29,
  NFC_ERROR_BAD_TECH_TYPE = -30
} NfcErrorCode;
