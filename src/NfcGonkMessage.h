...
typedef enum {
  ...
  NFC_ERROR_NFC_ALREADY_ON = -17,
  NFC_ERROR_NFC_ALREADY_OFF = -18,
  NFC_ERROR_ALREADY_DISCOVERY_ON = -19,
  NFC_ERROR_ALREADY_DISCOVERY_OFF = -20,
  NFC_ERROR_FAIL_ENABLE_DISCOVERY = -21,
  NFC_ERROR_FAIL_DISABLE_DISCOVERY = -22,
  NFC_ERROR_NOT_INITIALIZED = -23,
  NFC_ERROR_INITIALIZE_FAIL = -24,
  NFC_ERROR_DEINITIALIZE_FAIL = -25,
  NFC_ERROR_SE_ALREADY_SELECTED = -26,
  NFC_ERROR_SE_CONNECTED = -27,
  NFC_ERROR_NO_SE_CONNECTED = -28,
  NFC_ERROR_NOT_SUPPORTED = -29,
  NFC_ERROR_BAD_SESSION_ID = -30,
  NFC_ERROR_LOST_TECH = -31,
  NFC_ERROR_BAD_TECH_TYPE = -32
} NfcErrorCode;
